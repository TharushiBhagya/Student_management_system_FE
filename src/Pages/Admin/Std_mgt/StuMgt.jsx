...
import StudentForm from "../../../Components/Forms/addStu";
import RemoveStudentForm from "../../../Components/Forms/removeStu";
import UpdateStudentForm from "../../../Components/Forms/updateStu";
...
export default function StudentManagement() {
  ...
  const handleStudentAction = (message, type = "success") => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
          <div className="flex items-center">
            ...
            <span className="font-medium text-lg">Add New Student</span>
          </div>
        ...
        >
          <div className="flex items-center">
            ...
            <span className="font-medium text-lg">Update Student</span>
          </div>
        ...
        >
          <div className="flex items-center">
            ...
            <span className="font-medium text-lg">Remove Student</span>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-blue-100">
            <StudentForm 
              ...
              onSubmit={() => handleStudentAction("Student added successfully!")} 
            />
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-indigo-100">
            <UpdateStudentForm 
              ...
              onSubmit={() => handleStudentAction("Student updated successfully!")} 
            />
          </div>
        </div>
      )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 backdrop-blur-sm animate-fadeIn">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto border border-purple-100">
            <RemoveStudentForm 
              ...
              onSubmit={() => handleStudentAction("Student removed successfully!")} 
            />
          </div>
        </div>
      )}
